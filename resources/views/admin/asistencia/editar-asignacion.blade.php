        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.asistencia.asignaciones.update', $asignacion) }}" method="POST">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('area_laboral_id') is-invalid @enderror" 
                                        ...
                                        @foreach($areas as $area)
                                            <option value="{{ $area->id }}" {{ (old('area_laboral_id', $asignacion->area_laboral_id) == $area->id) ? 'selected' : '' }}>
                                                {{ $area->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('horario_trabajo_id') is-invalid @enderror" 
                                        ...
                                        @foreach($horarios as $horario)
                                            <option value="{{ $horario->id }}" {{ (old('horario_trabajo_id', $asignacion->horario_trabajo_id) == $horario->id) ? 'selected' : '' }}>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" 
                                           ...
                                           id="fecha_inicio" 
                                           name="fecha_inicio" 
                                           value="{{ old('fecha_inicio', $asignacion->fecha_inicio->format('Y-m-d')) }}" 
                                           required>
                                    @error('fecha_inicio')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" 
                                           ...
                                           id="fecha_fin" 
                                           name="fecha_fin" 
                                           value="{{ old('fecha_fin', $asignacion->fecha_fin ? $asignacion->fecha_fin->format('Y-m-d') : '') }}">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="activo" name="activo" value="1" {{ old('activo', $asignacion->activo) ? 'checked' : '' }}>
