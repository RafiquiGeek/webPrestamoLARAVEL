...
@section('title', 'Editar Horario de Trabajo')
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-edit mr-2"></i>Editar Horario de Trabajo</h1>
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-clock mr-2"></i>Editar: {{ $horario->nombre }}
                    </h3>
                </div>
                
                <form action="{{ route('admin.asistencia.horarios-trabajo.update', $horario) }}" method="POST" id="form-horario">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <!-- Información básica -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h5 class="mb-3"><i class="fas fa-clock text-muted mr-2"></i>Horario Principal</h5>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="hora_entrada">Entrada <span class="text-danger">*</span></label>
                                    <input type="time" 
                                           class="form-control @error('hora_entrada') is-invalid @enderror" 
                                           id="hora_entrada" 
                                           name="hora_entrada" 
                                           value="{{ old('hora_entrada', $horario->hora_entrada ? \Carbon\Carbon::parse($horario->hora_entrada)->format('H:i') : '') }}"
                                           required>
                                    @error('hora_entrada')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="hora_salida">Salida <span class="text-danger">*</span></label>
                                    <input type="time" 
                                           class="form-control @error('hora_salida') is-invalid @enderror" 
                                           id="hora_salida" 
                                           name="hora_salida" 
                                           value="{{ old('hora_salida', $horario->hora_salida ? \Carbon\Carbon::parse($horario->hora_salida)->format('H:i') : '') }}"
                                           required>
                                    @error('hora_salida')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" 
                                           ...
                                           value="{{ old('duracion_refrigerio_minutos', $horario->duracion_refrigerio_minutos) }}"
                                           min="1" 
                                           max="120"
                                           placeholder="30">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="time" 
                                           ...
                                           value="{{ old('inicio_refrigerio', $horario->inicio_refrigerio ? \Carbon\Carbon::parse($horario->inicio_refrigerio)->format('H:i') : '') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="time" 
                                           ...
                                           id="fin_refrigerio" 
                                           name="fin_refrigerio" 
                                           value="{{ old('fin_refrigerio', $horario->fin_refrigerio ? \Carbon\Carbon::parse($horario->fin_refrigerio)->format('H:i') : '') }}"
                                           readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" 
                                               ...
                                               value="{{ old('tolerancia_entrada', $horario->tolerancia_entrada) }}"
                                               min="0" 
                                               max="60"
                                               required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" 
                                               ...
                                               value="{{ old('tolerancia_salida', $horario->tolerancia_salida) }}"
                                               min="0" 
                                               max="60"
                                               required>
                                        <div class="input-group-append">
                                            ...
                                            <div class="card-body text-center">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" 
                                                           ...
                                                           value="simple"
                                                           {{ !$horario->esHorarioPersonalizado() ? 'checked' : '' }}>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    @php
                                        ...
                                        $diasSeleccionados = old('dias_laborales', $horario->dias_laborales ?? []);
                                    @endphp
                                                ...
                                                <div class="card-body text-center p-2">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" 
                                                               ...
                                                               name="dias_laborales[]" 
                                                               value="{{ $valor }}"
                                                               {{ in_array($valor, (array)$diasSeleccionados) ? 'checked' : '' }}>
                        ...
                        <div class="row" id="seccion-horarios-personalizados" style="display: none;">
                            <div class="col-12">
                                <h6 class="mb-3">Configuración por Días <span class="text-danger">*</span></h6>
                            </div>
                            <div class="col-12">
                                <div class="alert alert-info">
                                    <i class="fas fa-info-circle mr-2"></i>
                                    <strong>Horario Personalizado:</strong> Configura horarios diferentes para cada día de la semana.
                                </div>
                            </div>
                            @php
                                $diasPersonalizados = [
                                ...
                                $horariosSemanales = old('horarios_semanales', $horario->horarios_semanales ?? []);
                            @endphp
                            @foreach($diasPersonalizados as $valor => $nombre)
                                <div class="col-12 mb-4" id="dia-config-{{ $valor }}">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" 
                                                               ...
                                                               value="1"
                                                               {{ (isset($horariosSemanales[$valor]['activo']) && $horariosSemanales[$valor]['activo']) ? 'checked' : '' }}>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group mb-0">
                                                                <label class="small">Entrada <span class="text-danger">*</span></label>
                                                                <input type="time" 
                                                                       class="form-control form-control-sm" 
                                                                       name="horarios_semanales[{{ $valor }}][hora_entrada]"
                                                                       value="{{ $horariosSemanales[$valor]['hora_entrada'] ?? '' }}"
                                                                       {{ !(isset($horariosSemanales[$valor]['activo']) && $horariosSemanales[$valor]['activo']) ? 'disabled' : '' }}>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-group mb-0">
                                                                <label class="small">Salida <span class="text-danger">*</span></label>
                                                                <input type="time" 
                                                                       class="form-control form-control-sm" 
                                                                       name="horarios_semanales[{{ $valor }}][hora_salida]"
                                                                       value="{{ $horariosSemanales[$valor]['hora_salida'] ?? '' }}"
                                                                       {{ !(isset($horariosSemanales[$valor]['activo']) && $horariosSemanales[$valor]['activo']) ? 'disabled' : '' }}>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-4">
                                                            <div class="form-group mb-0">
                                                                ...
                                                                <input type="number" 
                                                                       ...
                                                                       value="{{ $horariosSemanales[$valor]['duracion_refrigerio_minutos'] ?? '' }}"
                                                                       min="1" max="120"
                                                                       placeholder="30"
                                                                       {{ !(isset($horariosSemanales[$valor]['activo']) && $horariosSemanales[$valor]['activo']) ? 'disabled' : '' }}>
                                                            </div>
                                                        ...
                                                        <div class="col-4">
                                                            <div class="form-group mb-0">
                                                                ...
                                                                <input type="time" 
                                                                       ...
                                                                       value="{{ $horariosSemanales[$valor]['inicio_refrigerio'] ?? '' }}"
                                                                       {{ !(isset($horariosSemanales[$valor]['activo']) && $horariosSemanales[$valor]['activo']) ? 'disabled' : '' }}>
                                                            </div>
                                                        </div>
                                                        <div class="col-4">
                                                            <div class="form-group mb-0">
                                                                ...
                                                                <input type="time" 
                                                                       ...
                                                                       value="{{ $horariosSemanales[$valor]['fin_refrigerio'] ?? '' }}"
                                                                       readonly
                                                                       {{ !(isset($horariosSemanales[$valor]['activo']) && $horariosSemanales[$valor]['activo']) ? 'disabled' : '' }}>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="text-center">
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-outline-success replicar-en" data-dia="{{ $valor }}" 
                                                                {{ !(isset($horariosSemanales[$valor]['activo']) && $horariosSemanales[$valor]['activo']) ? 'disabled' : '' }}>
                            ...
                            <div class="col-12">
                                <div class="alert alert-warning">
                                    ...
                                    <strong>Importante:</strong> Solo los días marcados como activos serán considerados como días laborales.
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div id="preview-horario">
                                                    <div class="d-flex justify-content-between mb-1">
                                                        ...
                                                        <strong id="preview-entrada">{{ $horario->hora_entrada ? \Carbon\Carbon::parse($horario->hora_entrada)->format('H:i') : '' }}</strong>
                                                    </div>
                                                    <div class="d-flex justify-content-between">
                                                        <span><i class="fas fa-sign-out-alt text-danger mr-1"></i>Salida:</span>
                                                        <strong id="preview-salida">{{ $horario->hora_salida ? \Carbon\Carbon::parse($horario->hora_salida)->format('H:i') : '' }}</strong>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div id="preview-refrigerio">
                                                    @if($horario->duracion_refrigerio_minutos)
                                                        <div class="d-flex justify-content-between mb-1">
                                                            <span>Duración:</span>
                                                            <strong>{{ $horario->duracion_refrigerio_minutos }} minutos</strong>
                                                        </div>
                                                        @if($horario->inicio_refrigerio)
                                                            <div class="d-flex justify-content-between mb-1">
                                                                <span>Inicio sugerido:</span>
                                                                <strong>{{ \Carbon\Carbon::parse($horario->inicio_refrigerio)->format('H:i') }}</strong>
                                                            </div>
                                                        @else
                                                            <div class="text-muted small">El empleado puede iniciar cuando desee</div>
                                                        @endif
                                                    @else
                                                ...
                                                <div id="preview-dias">
                                                    @if($horario->dias_laborales)
                                                        @foreach($horario->dias_laborales as $dia)
                                                            <span class="badge badge-success mr-1">{{ $diasSemana[$dia]['nombre'] ?? $dia }}</span>
                                                        @endforeach
                                                    @else
                                                        <span class="text-muted">Ningún día seleccionado</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="info-box bg-light">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">{{ $horario->created_at->format('d/m/Y') }}</span>
                                        <small>{{ $horario->created_at->diffForHumans() }}</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-box bg-light">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">{{ $horario->updated_at->format('d/m/Y') }}</span>
                                        <small>{{ $horario->updated_at->diffForHumans() }}</small>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-users mr-2"></i>Empleados con este Horario
                    </h3>
                </div>
                <div class="card-body">
                    @if($horario->empleados->count() > 0)
                        <div class="row">
                            @foreach($horario->empleados as $empleado)
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="alert alert-warning">
                ...
                <p class="mb-0">
                    Este horario está asignado a <strong>{{ $horario->empleados->count() }} empleado(s)</strong>. 
                    Los cambios afectarán inmediatamente el control de asistencia de estos empleados.
                </p>
            </div>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    // Calcular fin de refrigerio al cargar si ya hay datos
    if ($('#duracion_refrigerio_minutos').val() && $('#inicio_refrigerio').val()) {
    ...
    // Inicializar vista correcta
    if ($('#horario_personalizado').is(':checked')) {
        $('#seccion-dias-simples').hide();
        $('#seccion-horarios-personalizados').show();
    } else {
        $('#seccion-dias-simples').show();
