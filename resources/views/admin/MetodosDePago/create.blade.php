...
@section('content_header')
   <div class="d-flex justify-content-between align-items-center">
       <h1><i class="fas fa-plus-circle mr-2"></i>Crear Método de Pago</h1>
                           ...
                           <div class="form-group">
                               ...
                               <div class="input-group">
                                   ...
                                   <input type="text" class="form-control @error('metodo_pago') is-invalid @enderror" 
                                          name="metodo_pago" id="metodo_pago" value="{{ old('metodo_pago') }}" 
                                          placeholder="Ej. Transferencia Bancaria" required>
                                   @error('metodo_pago')
                                       <span class="invalid-feedback">{{ $message }}</span>
                                   @enderror
                               </div>
                               <small class="form-text text-muted">Ingrese el nombre del nuevo método de pago</small>
                           </div>
                       </div>
                       ...
                       <div class="col-md-12">
                           <div class="form-group">
                               ...
                               @error('status')
                                   <span class="invalid-feedback">{{ $message }}</span>
                               @enderror
                               <small class="form-text text-muted">Defina si el método de pago estará disponible para su uso</small>
                           </div>
                       </div>
                   </div>
                   ...
                   <div class="alert alert-info mt-3">
                       <div class="d-flex">
                           ...
                           <div>
                               ...
                               <p class="mb-0">Los métodos de pago creados estarán disponibles para ser seleccionados en las transacciones financieras.</p>
                           </div>
                       </div>
                   </div>
               </div>
