...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.gastos.update', $gasto->id) }}" method="POST" id="formGasto">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-8">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                              ...
                                              placeholder="Descripción detallada del gasto...">{{ old('descripcion', $gasto->descripcion) }}</textarea>
                                    @error('descripcion')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('tipo_documento') is-invalid @enderror" 
                                                ...
                                                <option value="DNI" {{ old('tipo_documento', $gasto->tipo_documento) == 'DNI' ? 'selected' : '' }}>DNI</option>
                                                <option value="RUC" {{ old('tipo_documento', $gasto->tipo_documento) == 'RUC' ? 'selected' : '' }}>RUC</option>
                                                <option value="CE" {{ old('tipo_documento', $gasto->tipo_documento) == 'CE' ? 'selected' : '' }}>Carné de Extranjería</option>
                                                <option value="PAS" {{ old('tipo_documento', $gasto->tipo_documento) == 'PAS' ? 'selected' : '' }}>Pasaporte</option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control @error('documento_identidad') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('documento_identidad', $gasto->documento_identidad) }}" 
                                ...
                                <div id="campos-empresa" style="display: {{ old('tipo_documento', $gasto->tipo_documento) == 'RUC' ? 'block' : 'none' }};">
                                    <div class="form-group">
                                        <label for="razon_social">Razón Social *</label>
                                        <input type="text" class="form-control @error('razon_social') is-invalid @enderror" 
                                               name="razon_social" id="razon_social" 
                                               value="{{ old('razon_social', $gasto->razon_social) }}" 
                                               maxlength="200">
                                        @error('razon_social')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div id="campos-persona" style="display: {{ old('tipo_documento', $gasto->tipo_documento) != 'RUC' ? 'block' : 'none' }};">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('nombres') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('nombres', $gasto->nombres) }}" 
                                                       maxlength="100">
                                                @error('nombres')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('apellidos') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('apellidos', $gasto->apellidos) }}" 
                                                       maxlength="100">
                                                @error('apellidos')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                    ...
                    <div class="col-md-4">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('tipo_comprobante') is-invalid @enderror" 
                                        ...
                                        <option value="boleta" {{ old('tipo_comprobante', $gasto->tipo_comprobante) == 'boleta' ? 'selected' : '' }}>Boleta de Venta</option>
                                        <option value="recibo_honorarios" {{ old('tipo_comprobante', $gasto->tipo_comprobante) == 'recibo_honorarios' ? 'selected' : '' }}>Recibo por Honorarios</option>
                                        <option value="ticket" {{ old('tipo_comprobante', $gasto->tipo_comprobante) == 'ticket' ? 'selected' : '' }}>Ticket</option>
                                        <option value="sin_documento" {{ old('tipo_comprobante', $gasto->tipo_comprobante) == 'sin_documento' ? 'selected' : '' }}>Sin Documento de Pago</option>
                                    </select>
                                ...
                                <div id="campos-comprobante" style="display: {{ old('tipo_comprobante', $gasto->tipo_comprobante) != 'sin_documento' ? 'block' : 'none' }};">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('serie_comprobante') is-invalid @enderror" 
                                               ...
                                               value="{{ old('serie_comprobante', $gasto->serie_comprobante) }}" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('numero_comprobante') is-invalid @enderror" 
                                               ...
                                               value="{{ old('numero_comprobante', $gasto->numero_comprobante) }}" 
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <textarea class="form-control @error('observaciones') is-invalid @enderror" 
                                              ...
                                              placeholder="Observaciones adicionales...">{{ old('observaciones', $gasto->observaciones) }}</textarea>
                                    @error('observaciones')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p><strong>Registrado por:</strong> {{ $gasto->usuario->name ?? 'N/A' }}</p>
                                <p><strong>Fecha de registro:</strong> {{ $gasto->created_at->format('d/m/Y H:i:s') }}</p>
                                @if($gasto->updated_at != $gasto->created_at)
                                    <p><strong>Última actualización:</strong> {{ $gasto->updated_at->format('d/m/Y H:i:s') }}</p>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{ route('admin.gastos.show', $gasto->id) }}" class="btn btn-info btn-block mt-2">
...
async function consultarDocumento() {
    ...
    try {
        const response = await fetch('/admin/gastos/consultar-documento', {
            method: 'POST',
            headers: {
        ...
        if (data.valid) {
            ...
            Swal.fire({
                ...
                text: 'Puede continuar editando los datos manualmente'
            });
        }
    } catch (error) {
        Swal.fire({
...
// Trigger inicial para mostrar campos correctos
