...
@section('content_header')
  <div class="container d-flex justify-content-between align-items-center">
      <h1><i class="fas fa-plus-circle mr-2"></i>Crear Nueva Zona</h1>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-12">
                          <div class="form-group">
                              ...
                              <small class="form-text text-muted">Ingrese un nombre descriptivo para la zona</small>
                          </div>
                      </div>
                          ...
                          <div class="form-group">
                              ...
                              <select name="sucursales[]" id="sucursales" 
                                  ...
                                  @foreach ($sucursales as $sucursal)
                                      <option value="{{ $sucursal->id }}" {{ in_array($sucursal->id, old('sucursales', [])) ? 'selected' : '' }}>
                                          {{ $sucursal->sucursal }}
                                      </option>
                                  @endforeach
                              </select>
                              @error('sucursales')
                                  <span class="invalid-feedback">{{ $message }}</span>
                              @enderror
                              <small class="form-text text-muted">Seleccione todas las sucursales que pertenecerán a esta zona</small>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="alert alert-info mt-3">
                      <div class="d-flex">
                          ...
                          <div>
                              ...
                              <p class="mb-0">Las zonas permiten organizar las sucursales en territorios para una mejor gestión y distribución de recursos.</p>
                          </div>
                      </div>
                  </div>
              </div>
