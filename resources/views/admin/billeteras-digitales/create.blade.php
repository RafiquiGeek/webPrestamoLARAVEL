...
@section('title', 'Crear Billetera Digital')
@section('content_header')
  <div class="d-flex justify-content-between align-items-center">
      <h1><i class="fas fa-plus-circle mr-2"></i>Crear Nueva Billetera Digital</h1>
  ...
  <div class="container-fluid pt-2">
      <div class="card card-outline card-primary shadow-sm">
          <div class="card-header">
              <h3 class="card-title">Información de la Billetera Digital</h3>
          </div>
          
          <form action="{{ route('admin.billeteras-digitales.store') }}" method="POST">
              @csrf
              <div class="card-body">
                  <div class="row">
                      ...
                      <div class="col-md-12">
                          <div class="form-group">
                              ...
                              <small class="form-text text-muted">Ingrese el nombre de la billetera digital</small>
                          </div>
                      </div>
                      ...
                      <div class="col-md-12">
                          <div class="form-group">
                              ...
                              @error('status')
                                  <span class="invalid-feedback">{{ $message }}</span>
                              @enderror
                              <small class="form-text text-muted">Defina si la billetera estará disponible para su uso</small>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="alert alert-info mt-3">
                      <div class="d-flex">
                          ...
                          <div>
                              ...
                              <p class="mb-0">Las billeteras digitales creadas estarán disponibles para ser seleccionadas al registrar cuentas de clientes en el sistema.</p>
                          </div>
                      </div>
                  </div>
              </div>
              ...
              <div class="card-footer bg-white">
                  <div class="d-flex justify-content-between">
                      ...
                      <button type="submit" class="btn btn-primary">
                          <i class="fas fa-save mr-1"></i>Guardar Billetera
                      </button>
                  </div>
              </div>
          </form>
