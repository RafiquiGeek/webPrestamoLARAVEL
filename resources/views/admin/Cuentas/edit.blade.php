...
@section('content_header')
  <div class="d-flex justify-content-between align-items-center">
      <h1><i class="fas fa-edit mr-2"></i>Editar Cuenta</h1>
  ...
  <div class="container-fluid pt-2">
      <div class="card card-outline card-primary shadow-sm">
          <div class="card-header">
              <h3 class="card-title">Modificar Información de la Cuenta</h3>
          </div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-4">
                          <div class="form-group">
                              ...
                              <select class="form-control @error('entidadFinanciera') is-invalid @enderror" 
                                      id="entidadFinanciera" name="entidadFinanciera" required>
                                  <option value="">Selecciona una entidad</option>
                                  @foreach ($entBancarias as $entBancaria)
                                      <option value="{{ $entBancaria->id }}" {{ old('entidadFinanciera', $cuenta->entidad_bancaria_id) == $entBancaria->id ? 'selected' : '' }}>
                                          {{ $entBancaria->banco }}
                                      </option>
                                  @endforeach
                              </select>
                          ...
                          <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <input type="text" class="form-control @error('nro_cuenta') is-invalid @enderror" 
                                         name="nro_cuenta" id="nro_cuenta" value="{{ old('nro_cuenta', $cuenta->nro_cuenta) }}" 
                          ...
                          <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <input type="text" class="form-control @error('codigo') is-invalid @enderror" 
                                         name="codigo" id="codigo" value="{{ old('codigo', $cuenta->codigo) }}" 
                  ...
                  <div class="alert alert-warning mt-3">
                      <div class="d-flex">
                          ...
                          <div>
                              ...
                              <p class="mb-0">Modificar los datos de una cuenta podría afectar a las transacciones financieras asociadas. Asegúrese de revisar el impacto antes de guardar los cambios.</p>
                          </div>
                      </div>
                  </div>
              </div>
