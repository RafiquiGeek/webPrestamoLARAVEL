    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-12 text-center">
                ...
                <p class="text-muted">Modificar datos de la etiqueta existente</p>
            </div>
        </div>
    </div>
@stop
...
@section('content')
    <div class="container-fluid">
        <form action="{{ route('admin.etiquetas.update', $etiqueta->id) }}" method="POST" class="needs-validation" novalidate>
            @csrf
            @method('PUT')
                ...
                <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('etiqueta', $etiqueta->etiqueta) }}" 
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="color" class="form-label font-weight-bold">
                                        <i class="fas fa-palette mr-1 text-info"></i>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <span class="input-group-text" id="colorDisplay" style="background-color: {{ old('color', $etiqueta->color) }}; color: white; min-width: 100px;">
                                                Vista Previa
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="estado" id="estado" class="form-control @error('estado') is-invalid @enderror" required>
                                        ...
                                        <option value="1" {{ old('estado', $etiqueta->estado) == '1' ? 'selected' : '' }}>Activa</option>
                                        <option value="0" {{ old('estado', $etiqueta->estado) == '0' ? 'selected' : '' }}>Inactiva</option>
                                    </select>
                                    @error('estado')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="p-3 bg-light rounded border">
                                        <span id="etiquetaPreview" class="badge px-3 py-2" style="background-color: {{ $etiqueta->color }}; color: white; font-size: 14px;">
                                            {{ $etiqueta->etiqueta }}
                                        </span>
                                    </div>
                                </div>
                    ...
                    <div class="card shadow-sm border-0 mb-4">
                        <div class="card-header bg-gradient-info text-white">
                            <h5 class="mb-0">
                                <i class="fas fa-chart-bar mr-2"></i>Estadísticas de Uso
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="alert alert-warning mt-3">
                                ...
                                <strong>Nota:</strong> Esta etiqueta está siendo utilizada por {{ $etiqueta->etiquetasCliente->count() }} préstamos. 
                        ...
                        <div class="card-body">
                            <div class="alert alert-info border-left-info mb-3">
                                <h6 class="font-weight-bold mb-2">
                                    <i class="fas fa-history mr-1"></i>Información de la Etiqueta
                                </h6>
                                <small>
                                    <strong>Creada:</strong> {{ $etiqueta->created_at->format('d/m/Y H:i') }}<br>
                                    <strong>Última actualización:</strong> {{ $etiqueta->updated_at->format('d/m/Y H:i') }}
                                </small>
                            </div>

                            <div class="info-block mb-3">
                                <h6 class="font-weight-bold text-muted mb-2">Estado Actual:</h6>
                                @if($etiqueta->estado)
                            ...
                            <div class="mt-4">
                                <button type="submit" class="btn btn-warning btn-lg btn-block">
                                    <i class="fas fa-save mr-2"></i>Actualizar Etiqueta
                                </button>
